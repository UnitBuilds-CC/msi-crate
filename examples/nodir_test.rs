/// Test: InstallExecuteSequence WITHOUT Directory table.
fn main() {
    let mut b = velocity_msi::MsiBuilder::new();
    b.set_title("NoDir Test");
    b.set_author("V");
    ...
    b.insert_rows("Property", vec![
        vec![velocity_msi::Value::from("ProductName"), velocity_msi::Value::from("NoDir")],
    ...
    // InstallExecuteSequence but NO Directory table
    ...
    std::fs::write("nodir_test.msi", &data).unwrap();
    println!("Wrote nodir_test.msi ({} bytes)", data.len());
}
