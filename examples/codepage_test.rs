/// Quick test: codepage 65001 (UTF-8) in both SummaryInfo and string pool.
/// This matches the msi crate's default behavior.
...
fn main() {
    ...
    b.insert_rows("Property", vec![
        vec![velocity_msi::Value::from("ProductName"), velocity_msi::Value::from("CP65001Test")],
